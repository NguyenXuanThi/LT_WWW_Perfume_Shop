...
type PriceFilter = "ALL" | "UNDER_2M" | "FROM_2_TO_4" | "FROM_4_TO_6" | "ABOVE_6";
...
const GENDER_CONFIGS: Record<string, GenderConfig> = {
  "tat-ca": {
    ...
    breadcrumb: "Tất cả",
    description: "Khám phá thế giới nước hoa đa dạng và phong phú. Tại đây bạn sẽ tìm thấy tất cả những mùi hương tuyệt vời nhất dành cho mọi phong cách và cá tính.",
  },
  nam: {
    gender: "MALE",
    title: "Nước hoa nam",
    breadcrumb: "Nước hoa nam",
    description: "Các quý ông đang tìm đến nước hoa để làm gì? Có lẽ là để thơm hơn, nam tính và làm chỉn chu thêm phong cách của bản thân. Shop hiểu các quý ông của chúng ta: một chai nước hoa cho công việc mỗi ngày, một chai cho các buổi hẹn hò hoặc những dịp đặc biệt.",
  },
  nu: {
    gender: "FEMALE",
    title: "Nước hoa nữ",
    breadcrumb: "Nước hoa nữ",
    description: "Khám phá bộ sưu tập nước hoa nữ đa dạng từ các thương hiệu hàng đầu thế giới. Từ hương hoa ngọt ngào đến những mùi hương quyến rũ, tinh tế - mỗi chai nước hoa là một câu chuyện riêng dành cho phái đẹp.",
  },
  unisex: {
    gender: "UNISEX",
    title: "Nước hoa unisex",
    breadcrumb: "Nước hoa unisex",
    description: "Nước hoa unisex - sự lựa chọn hoàn hảo cho những ai yêu thích phong cách tự do, không giới hạn. Những mùi hương trung tính, tinh tế phù hợp cho cả nam và nữ, mang đến sự thanh lịch và cá tính riêng biệt.",
  },
};
...
const ProductListPage = () => {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return result;
  }, [genderFilteredProducts, selectedBrands, priceFilter, sortBy, categoryFilter]);
